...
public class ThreadForLoopD extends Thread{
    ...
    public ThreadForLoopD(int _width, int _height, int _precision, double[][] _field, double _MASS, List<ArrayList<Double>> _list) {
        width = _width;
        height = _height;
    ...
    @Override
    public void run () {
        for (int x = 3*width / 4; x < width; x += precision) {
