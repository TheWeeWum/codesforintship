...
public class ThreadForLoopB extends Thread{
    ...
    public ThreadForLoopB(int _width, int _height, int _precision, double[][] _field, double _MASS, List<ArrayList<Double>> _list) {
        width = _width;
        height = _height;
    ...
    @Override
    public void run () {
        for (int x = 1*width / 4; x < 2*width / 4; x += precision) {
