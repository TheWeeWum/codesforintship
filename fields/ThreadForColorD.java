...
public class ThreadForColorD extends Thread {
    ...
    public ThreadForColorD(int _ZOOM, double _gradient, Graphics2D _screen, int _precision, double _largestG, List<ArrayList<Double>> _list) {
        ZOOM = _ZOOM;
        gradient = _gradient;
        screen = _screen;
